...
def main():
    ...
    parser.add_argument("--activation-clamp-min", type=float, help="Optional lower bound applied before each non-clamp activation")
    parser.add_argument("--activation-clamp-max", type=float, help="Optional upper bound applied before each non-clamp activation")
